...
## data属性的值为引用类型时，手动刷新模板的方法

* \[ ... originArr\]
* this.$set
* 数组的pop push shift unshift reverse splice sort方法会重新渲染，下标的形式不会重新渲染
* 对象的属性修改会重新渲染，添加新的属性不会重新渲染
...
* 非props特性（子组件没有定义props）：传递的属性会显示在DOM上；组件内无法使用
...
![](../.gitbook/assets/360截图18430710236452.png)
...
* 子组件可能会复用，如果指向的是同一个引用类型的地址，属性的修改互相影响。
...
![](../.gitbook/assets/360截图20180405181228155.jpg)

![](../.gitbook/assets/360截图20180405180939734.jpg)

* 什么是动态路由？
  * 参数获取$route.params.goodsId

![](../.gitbook/assets/360截图20180405180333282.jpg)

* 嵌套路由

![](../.gitbook/assets/360截图20180405181555567.jpg)

![](../.gitbook/assets/360截图20180405181833071.jpg)

* 编程式路由
  * 获取参数$route.query.goodsId

![](../.gitbook/assets/360截图20180405182517733.jpg)
...
![](../.gitbook/assets/360截图20180405184648908.jpg)

* 命名视图

![](../.gitbook/assets/360截图20180405185027691.jpg)

![](../.gitbook/assets/360截图20180405185159053.jpg)
